	...
	<div class="header-block">
		<div class="watch-block">
			...
			<div class="button-bloc">
				<div class="btn"><button class="prev-btn"><h4 class="prev">1 серия</h4></button></div>
				<div class="btn"><button class="episod-btn"><h4>Список всех серий</h4></button></div>
				<div class="btn"><button class="next-btn"><h4 class="next">3 серия</h4></button></div>
			</div>
		</div>
	</div>
</div>